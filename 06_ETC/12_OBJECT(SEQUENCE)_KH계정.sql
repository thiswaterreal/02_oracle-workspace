...
/*
    ...
    [MAXVALUE 숫자]                 -- 최대값 지정 (기본값 겁나 큼..9999999999999999)
...
-- 왜? CURRVAL 은 마지막으로 성공적으로 수행된 NEXTVAL 값이기 때문에!!

-- *** SELECT 여러번 치지 말기!! ***
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; -- 300
SELECT SEQ_EMPNO.CURRVAL FROM DUAL; -- 300 : 마지막으로 성공한 NEXTVAL 의 값
...
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; -- (실패) 지정한 MAXVALUE 값 초과했기 때문에 오류 발생!!
SELECT SEQ_EMPNO.CURRVAL FROM DUAL; -- 310 : 마지막으로 성공한 NEXTVAL 의 값
