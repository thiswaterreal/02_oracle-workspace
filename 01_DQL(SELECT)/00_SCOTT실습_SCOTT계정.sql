...
SELECT ENAME, SUBSTR(HIREDATE, 1, 2)||'년' AS "년도", SUBSTR(HIREDATE, 4, 2)||'월' AS "월"
FROM EMP;
...
SELECT EMPNO, ENAME, HIREDATE, ADD_MONTHS(HIREDATE, 480) AS "입사일로부터 40년 후"
FROM EMP;

-- 18. EMP테이블에서 입사일로부터 38년 이상 근무한 직원의 정보 조회 (근무년수)
SELECT *
FROM EMP
