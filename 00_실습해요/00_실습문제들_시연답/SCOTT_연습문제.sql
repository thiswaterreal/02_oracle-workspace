...
SELECT EMPNO, ENAME, TO_NUMBER(SUBSTR(SAL,1,LENGTH(SAL)-2) ||'00')
FROM EMP
ORDER BY 3 DESC;
...
SELECT ENAME, HIREDATE, TO_CHAR(HIREDATE,'YYYY"년" MM"월" DD"일"') AS "입사일"
FROM EMP;
...
SELECT EMPNO, ENAME, HIREDATE, ADD_MONTHS(HIREDATE, 480) AS "AFTER 40 YEARS"
FROM EMP;
